...
public class PhanQuyenBUS {
    ...
    public boolean Insert(String tenQuyen) {
        ...
        if (phanQuyenDAO.insert(new PhanQuyenDTO(maQuyen, tenQuyen, false, false, false, false, false, false, false,
    ...
    public PhanQuyenDTO getById(String ma) {
        return phanQuyenDAO.selectById(new PhanQuyenDTO(ma, null, false, false, false, false, false, false, false,
    ...
    public void loadData(JTable table) {
        DefaultTableModel model = new DefaultTableModel(
                new String[] {
                        "Mã", "Tên", "Khách Hàng", "Bán Hàng", "Nhập Hàng", "Món", "Nguyên Liệu", "Lịch Làm",
