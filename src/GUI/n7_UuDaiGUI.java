...
public class n7_UuDaiGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PanelKhuyenMai.setBackground(Util.UIHelper.SURFACE_ALT); // Inactive color (Faint green)
        ...
        PanelUuDai.setBackground(Util.UIHelper.ACCENT_GREEN); // Active color
        ...
        PanelThongTinUuDai.setBackground(Util.UIHelper.SURFACE);
        ...
        PanelThongTinUuDaiLayout.setHorizontalGroup(
                PanelThongTinUuDaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                PanelThongTinUuDaiLayout.createSequentialGroup()
                                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2.setBackground(Util.UIHelper.SURFACE);
                                                ...
                                                .addGroup(PanelTongLayout
                                                        ...
                                                        .addGroup(PanelTongLayout
                                                                .createParallelGroup(
                                                                        javax.swing.GroupLayout.Alignment.LEADING,
                                                                        false)
                                                                .addComponent(PanelThongTinUuDai_Cam,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addGroup(PanelTongLayout.createSequentialGroup()
    ...
    private void check_input_Rong() {
        n7_KhuyenMai_UuDaiBUS.getInstance().check_input_Rong(TextFieldMa, TextFieldTen, NgayBatDau, NgayKetThuc,
                TextFieldPhanTram, TextFieldDieuKien);
    }
    ...
    private void nhomChucNang() {
        ...
        PanelKhuyenMai.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseExited(java.awt.event.MouseEvent evt) {
                ...
                PanelKhuyenMai.setBackground(Util.UIHelper.SURFACE_ALT);
            }
        ...
        btn_Them.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (n7_KhuyenMai_UuDaiBUS.getInstance().check_input_Rong(TextFieldMa, TextFieldTen, NgayBatDau,
                    ...
                    int response = JOptionPane.showConfirmDialog(null, "Bạn có muốn thêm ưu đãi không?", "Xác nhận",
                            JOptionPane.YES_NO_OPTION);

                    if (response == JOptionPane.YES_OPTION) {
                        boolean i = n7_KhuyenMai_UuDaiBUS.getInstance().insert_uuDai(TextFieldMa.getText(),
        ...
        btn_Sua.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (TextFieldMa.getText().equals(n7_KhuyenMai_UuDaiBUS.getInstance().taoMaUuDai())) {
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn 1 ưu đãi trong danh sách để sửa!", "Thông báo",
                    ...
                    if (n7_KhuyenMai_UuDaiBUS.getInstance().check_input_Rong(TextFieldMa, TextFieldTen, NgayBatDau,
                        ...
                        int response = JOptionPane.showConfirmDialog(null, "Bạn có muốn sửa ưu đãi không?", "Xác nhận",
                                JOptionPane.YES_NO_OPTION);

                        if (response == JOptionPane.YES_OPTION) {
                            int i = n7_KhuyenMai_UuDaiBUS.getInstance().update_uuDai(TextFieldMa.getText(),
                                    TextFieldTen.getText(),
                                    start_sql, end_sql, Float.valueOf(TextFieldPhanTram.getText()), tien);
                            if (i == 1 || i == 0) {
                                reset();
