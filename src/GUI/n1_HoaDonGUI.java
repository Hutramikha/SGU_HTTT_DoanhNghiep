...
public class n1_HoaDonGUI extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                PanelTimKiemHoaDonLayout.setHorizontalGroup(
                                PanelTimKiemHoaDonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(PanelTimKiemHoaDonLayout.createSequentialGroup()
                                                                ...
                                                                .addGap(21, 21, 21))
                                                .addGroup(
                                                                PanelTimKiemHoaDonLayout.createParallelGroup(
                                                                                javax.swing.GroupLayout.Alignment.LEADING)
                                                                                .addGroup(PanelTimKiemHoaDonLayout
                                                                                                .createSequentialGroup()
                ...
                TblHoaDon.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "Mã hóa đơn", "Ngày lập", "Mã nhân viên", "Mã khuyến mãi",
                                                "Mã khách hàng", "Mã ưu đãi",
                                                "Tổng tiền"
                                }));
        ...
        public boolean validateFields() {
                ...
                if (!txtGiaTu.getText().equals("") && giaTu.matches("-?\\d+")) {
                        ...
                        if (giaTuValue < 0) {
                                JOptionPane.showMessageDialog(null, "Trường giá từ phải là số lớn hơn hoặc bằng 0!",
                                                "Lỗi",
                                                JOptionPane.ERROR_MESSAGE);
                                return false;
                        }
                ...
                if (!giaTu.equals("") && !denGia.equals("")) {
                        if ((Integer.parseInt(giaTu) > Integer.parseInt(denGia))) {
                                JOptionPane.showMessageDialog(null,
                                                "Trường giá từ phải nhỏ hơn trường giá đến\nVui lòng chọn lại!",
