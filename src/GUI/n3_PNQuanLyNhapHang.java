...
public class n3_PNQuanLyNhapHang extends javax.swing.JPanel {
    ...
    private n3_PNNhapHang nhapHangPanel;
    private n3_PNPhieuNhap phieuNhapPanel;
    ...
    public n3_PNQuanLyNhapHang(String MaNhanVien) {
        ...
        if (nhapHangPanel == null) {
            nhapHangPanel = new n3_PNNhapHang(MaNhanVien);
        }
        showContentPanel(nhapHangPanel);
    }
    ...
    private void initComponents() {
        ...
        jP_NhapHangLayout.setHorizontalGroup(
                jP_NhapHangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jP_NhapHangLayout.createSequentialGroup()
                                ...
                                .addGroup(
                                        jP_NhapHangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jP_NhapHang_PhieuNhap,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, 1113, Short.MAX_VALUE)
                                                .addComponent(jP_NoiDung, javax.swing.GroupLayout.DEFAULT_SIZE, 1113,
                                                        Short.MAX_VALUE))
                                .addContainerGap()));
        jP_NhapHangLayout.setVerticalGroup(
                jP_NhapHangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jP_NhapHangLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(jP_NhapHang_PhieuNhap, javax.swing.GroupLayout.PREFERRED_SIZE,
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jP_NhapHang, javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    private void showContentPanel(javax.swing.JPanel panel) {
        ...
        jP_NoiDung.add(panel, BorderLayout.CENTER);
        ...
        jL_NhapHang.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (selectedLabel != jL_NhapHang) {
                    jL_NhapHang.setOpaque(true);
                    jL_NhapHang.setBackground(Util.UIHelper.LIGHTER_GREEN); // Màu khi rê chuột vào
                } else {
                    jL_NhapHang.setOpaque(true);
                }
            }
            ...
            public void mouseExited(java.awt.event.MouseEvent evt) {
                if (selectedLabel != jL_NhapHang) {
                    jL_NhapHang.setBackground(Util.UIHelper.LIGHTEST_GREEN); // Màu mặc định khi kéo chuột ra
                } else {
                    jL_NhapHang.setBackground(Util.UIHelper.ACCENT_GREEN); // Màu của JLabel đã chọn
                }
            }
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                jL_NhapHang.setBackground(Util.UIHelper.ACCENT_GREEN); // Đặt màu cho JLabel được chọn
                jL_PhieuNhap.setBackground(Util.UIHelper.LIGHTEST_GREEN); // Đặt lại màu cho JLabel khác
        ...
        jL_PhieuNhap.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (selectedLabel != jL_PhieuNhap) {
                    jL_PhieuNhap.setOpaque(true);
                    jL_PhieuNhap.setBackground(Util.UIHelper.LIGHTER_GREEN); // Màu khi rê chuột vào
                } else {
                    jL_PhieuNhap.setOpaque(true);
                    // jL_PhieuNhap.setBackground(Color.white); // Màu khi rê chuột vào JLabel đã
                    // chọn
                }
            }
            ...
            public void mouseExited(java.awt.event.MouseEvent evt) {
                if (selectedLabel != jL_PhieuNhap) {
                    jL_PhieuNhap.setBackground(Util.UIHelper.LIGHTEST_GREEN); // Màu mặc định khi kéo chuột ra
                } else {
                    jL_PhieuNhap.setBackground(Util.UIHelper.ACCENT_GREEN); // Màu của JLabel đã chọn
                }
            }
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                jL_PhieuNhap.setBackground(Util.UIHelper.ACCENT_GREEN); // Đặt màu cho JLabel được chọn
                jL_NhapHang.setBackground(Util.UIHelper.LIGHTEST_GREEN); // Đặt lại màu cho JLabel khác

                if (phieuNhapPanel == null) {
                    phieuNhapPanel = new n3_PNPhieuNhap();
                }
                showContentPanel(phieuNhapPanel);
            }
        });
    }
