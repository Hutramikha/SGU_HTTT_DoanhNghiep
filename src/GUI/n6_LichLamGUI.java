        ...
        private void initComponents() {
                ...
                PanelSuaLayout.setHorizontalGroup(
                                PanelSuaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                                PanelSuaLayout.createSequentialGroup()
                                                                                .addContainerGap(21, Short.MAX_VALUE)
                                                                                .addComponent(Sua)
                                                                                .addGap(18, 18, 18)));
                PanelSuaLayout.setVerticalGroup(
                                PanelSuaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(Sua, javax.swing.GroupLayout.DEFAULT_SIZE, 30,
                                                                Short.MAX_VALUE));
                ...
                PanelTaiLaiLayout.setHorizontalGroup(
                                PanelTaiLaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                                PanelTaiLaiLayout.createSequentialGroup()
                                                                                .addContainerGap(33, Short.MAX_VALUE)
                                                                                .addComponent(TaiLai)
                                                                                .addGap(31, 31, 31)));
                PanelTaiLaiLayout.setVerticalGroup(
                                PanelTaiLaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(TaiLai, javax.swing.GroupLayout.DEFAULT_SIZE, 30,
                                                                Short.MAX_VALUE));
                ...
                Table.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "Nhân Viên", "T2 (28/11)", "T3 (29/11)", "T4 (30/11)", "T5 (31/11)",
                                                "T6 (10/12)", "T7 (10/12)",
                                                "CN (10/12)"
                                }) {
                                ...
                                PanelTimKiemLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(PanelTimKiemLayout.createSequentialGroup()
                                                                ...
                                                                .addComponent(TextFieldTimKiem,
                                                                                ...
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addGap(3, 3, 3)
                                                                .addComponent(datechooserTimKiem,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE,
        ...
        public void nhomNutChucNang() {
                        ...
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                                if (datechooser.getDate() == null) {
                                        JOptionPane.showMessageDialog(null,
                                                        "Vui lòng chọn ngày bất kỳ trong tuần làm để tạo tuần làm !",
                                ...
                                int response = JOptionPane.showConfirmDialog(null,
                                                "Bạn có muốn tạo lich làm tuần không?", "Xác nhận",
                ...
                PanelSua.addMouseListener(new java.awt.event.MouseAdapter() {
                        ...
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                                ...
                                if (datechooser.getDate() == null) {
                                        JOptionPane.showMessageDialog(null,
                                                        "Vui lòng chọn ngày để điều chỉnh lịch làm !", "FAIL",
                                                        JOptionPane.ERROR_MESSAGE);
                                        return;
                                }
                                if (isPastDay(selectedDate)) {
                ...
                PanelXoa.addMouseListener(new java.awt.event.MouseAdapter() {
                        ...
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                                Date selectedDate = datechooser.getDate();
                                if (datechooser.getDate() == null) {
                                        JOptionPane.showMessageDialog(null, "Vui lòng chọn ngày để tắt ca làm !",
                                                        "FAIL",
                                                        JOptionPane.ERROR_MESSAGE);
                                        return;
                                }
                ...
                datechooserTimKiem.getDateEditor().addPropertyChangeListener("date", evt -> {
                        if (datechooserTimKiem.getDate() != null) {
                                String formattedDate = new SimpleDateFormat("dd/MM/yyyy")
                                                .format(datechooserTimKiem.getDate());
