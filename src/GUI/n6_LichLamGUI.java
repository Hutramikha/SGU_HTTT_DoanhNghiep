    ...
    private void initComponents() {
        ...
        PanelTaoLayout.setVerticalGroup(
                PanelTaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(PanelTaoLayout.createSequentialGroup()
                                .addGap(5, 5, 5)
                                .addComponent(Tao, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
        ...
        PanelXoaLayout.setVerticalGroup(
                PanelXoaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(PanelXoaLayout.createSequentialGroup()
                                .addGap(5, 5, 5)
                                .addComponent(Xoa, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)));
                        ...
                        .addGroup(PanelThuocTinhLayout.createSequentialGroup()
                                .addGroup(PanelThuocTinhLayout
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, PanelThuocTinhLayout
                                                ...
                                                .addComponent(LabelNgayLam, javax.swing.GroupLayout.PREFERRED_SIZE, 72,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(datechooser, javax.swing.GroupLayout.PREFERRED_SIZE, 118,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(PanelThuocTinhLayout.createSequentialGroup()
                                                .addComponent(LabelNhanVien, javax.swing.GroupLayout.PREFERRED_SIZE, 72,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(comboboxNhanVien, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        118, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(PanelThuocTinhLayout.createSequentialGroup()
                                                .addComponent(LabelCaLam, javax.swing.GroupLayout.PREFERRED_SIZE, 72,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(comboboxCaLam, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        118, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        Table.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Nhân Viên", "T2 (28/11)", "T3 (29/11)", "T4 (30/11)", "T5 (31/11)", "T6 (10/12)", "T7 (10/12)",
                        "CN (10/12)"
                }) {
        ...
        PanelThoiGianLayout.setHorizontalGroup(
                PanelThoiGianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                PanelThoiGianLayout.createSequentialGroup()
                ...
                PanelTimKiemLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(PanelTimKiemLayout.createSequentialGroup()
                                ...
                                .addComponent(TextFieldTimKiem, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(3, 3, 3)
                                .addComponent(datechooserTimKiem, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
                ...
                PanelTongLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(PanelTongLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 23,
                                        Short.MAX_VALUE)
                                .addGroup(PanelTongLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(PanelThoiGian, javax.swing.GroupLayout.Alignment.TRAILING,
                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void nhomNutChucNang() {
        ...
        PanelTao.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (datechooser.getDate() == null) {
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn ngày bất kỳ trong tuần làm để tạo tuần làm !",
                ...
                if (selectedDate.before(currentDate)) {
                    JOptionPane.showMessageDialog(null, "Không thể tạo lịch làm cho ngày trong quá khứ!", "FAIL",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }

                int response = JOptionPane.showConfirmDialog(null, "Bạn có muốn tạo lich làm tuần không?", "Xác nhận",
        ...
        PanelSua.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Date selectedDate = datechooser.getDate();
                if (datechooser.getDate() == null) {
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn ngày để điều chỉnh lịch làm !", "FAIL",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                Date currentDate = new Date();
                ...
                if (selectedDate.before(currentDate)) {
                    JOptionPane.showMessageDialog(null, "Không thể điều chỉnh lịch làm cho ngày trong quá khứ!", "FAIL",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                String Ngay_formatted = Util.LichLam_CaLam.datechooser_cast_dangChuan(selectedDate);
        ...
        PanelXoa.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Date selectedDate = datechooser.getDate();
                if (datechooser.getDate() == null) {
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn ngày để tắt ca làm !", "FAIL",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                Date currentDate = new Date();
                ...
                if (selectedDate.before(currentDate)) {
                    JOptionPane.showMessageDialog(null, "Không thể sửa ca làm cho ngày trong quá khứ!", "FAIL",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                String Ngay_formatted = Util.LichLam_CaLam.datechooser_cast_dangChuan(selectedDate);
        ...
        PanelTaiLai.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                ...
                TaiLai.setOpaque(true);
                TaiLai.setBackground(Util.UIHelper.PRIMARY_GREEN);
            }

            public void mouseExited(java.awt.event.MouseEvent evt) {
                PanelTaiLai.setBackground(Util.UIHelper.DARK_GREEN);
                TaiLai.setOpaque(true);
                TaiLai.setBackground(Util.UIHelper.DARK_GREEN);
            }
