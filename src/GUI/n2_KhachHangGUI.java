...
public class n2_KhachHangGUI extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                PanelChuaNut.setBackground(new java.awt.Color(255, 255, 255, 0));
                PanelChuaNut.setOpaque(false);

                btn_Sua.putClientProperty("uihelper.ignore", true);
                btn_Sua.setBackground(Util.UIHelper.DARK_GREEN);
                btn_Sua.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
                btn_Sua.setForeground(new java.awt.Color(255, 255, 255));
                btn_Sua.setText("Sửa");
                btn_Sua.setPreferredSize(new java.awt.Dimension(120, 35));
                Util.UIHelper.styleButton(btn_Sua);
                btn_Sua.setBackground(Util.UIHelper.DARK_GREEN);

                btn_Them.putClientProperty("uihelper.ignore", true);
                btn_Them.setBackground(Util.UIHelper.DARK_GREEN);
                btn_Them.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
                btn_Them.setForeground(new java.awt.Color(255, 255, 255));
                btn_Them.setText("Thêm");
                btn_Them.setPreferredSize(new java.awt.Dimension(120, 35));
                Util.UIHelper.styleButton(btn_Them);
                btn_Them.setBackground(Util.UIHelper.DARK_GREEN);
                ...
                PanelChuaNutLayout.setHorizontalGroup(
                                PanelChuaNutLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PanelChuaNutLayout
                                                                .createSequentialGroup()
                                                                .addGap(15, 15, 15)
                ...
                ScrollPane.setPreferredSize(new java.awt.Dimension(700, 440));
                ...
                PanelTimKiem.setMinimumSize(new java.awt.Dimension(300, 32));
                PanelTimKiem.setPreferredSize(new java.awt.Dimension(300, 32));
                ...
                cmbTimKiem.setModel(
                                new javax.swing.DefaultComboBoxModel<>(new String[] { "Tìm theo mã", "Tìm theo tên" }));

                btn_XuatExcel.setBackground(Util.UIHelper.DARK_GREEN);
                ...
                btn_XuatExcel.setPreferredSize(new java.awt.Dimension(160, 40));
                Util.UIHelper.styleButton(btn_XuatExcel);
                ...
                layout.setVerticalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(PanelTong, javax.swing.GroupLayout.DEFAULT_SIZE, 667,
                                                                Short.MAX_VALUE));
        ...
        public void nhomNutChucNang() {
                ...
                BtnTimKiem.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("ENTER"),
                                "pressEnter");
        ...
        public boolean validateFields() {
                ...
                if (ten.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Tên không được để trống!", "Lỗi",
                                        JOptionPane.ERROR_MESSAGE);
                        return false;
                }
                if (ten.length() > 50) {
                        JOptionPane.showMessageDialog(null, "Độ dài tên không quá 50 ký tự!", "Lỗi",
                                        JOptionPane.ERROR_MESSAGE);
                        return false;
                ...
                if (sdt.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Số điện thoại không được để trống!", "Lỗi",
                                        JOptionPane.ERROR_MESSAGE);
                        return false;
                }
                if (!sdt.matches("^0\\d{9}$")) {
                        JOptionPane.showMessageDialog(null,
                                        "Số điện thoại phải bắt đầu bằng số 0 và chứa đúng 10 chữ số!", "Lỗi",
                                        JOptionPane.ERROR_MESSAGE);
                        return false;
                }
        ...
        public boolean validateFieldsSua() {
                ...
                if (TextFieldMa.getText().equals("")) {
                        JOptionPane.showMessageDialog(null, "Bạn chưa chọn khách hàng!", "Lỗi",
                                        JOptionPane.ERROR_MESSAGE);
                        return false;
                }
                if (ten.isEmpty()) {
