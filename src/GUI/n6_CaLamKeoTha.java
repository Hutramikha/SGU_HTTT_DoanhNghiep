...
public class n6_CaLamKeoTha extends javax.swing.JPanel {
                                                ...
                                                .addGroup(PanelCacTextLayout.createSequentialGroup()
                                                                ...
                                                                .addGroup(PanelCacTextLayout
                                                                                ...
                                                                                .addComponent(line2,
                                                                                                ...
                                                                                                75,
                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                .addComponent(TextTenCa,
                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                93,
                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                .addComponent(TextThoiGianVaoCa,
                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                93,
                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                .addComponent(TextThoiGianRa,
                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                93,
                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                .addComponent(line3,
                                                ...
                                                .addGroup(PanelTongLayout.createSequentialGroup()
                                                                .addGroup(PanelTongLayout.createParallelGroup(
                                                                                ...
                                                                                .addGroup(PanelTongLayout
                                                                                                .createSequentialGroup()
                                                                                                .addGap(62, 62, 62)
                                                                                                .addComponent(PanelLichLam,
                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                .addGap(30, 30, 30)
                                                                                                .addComponent(PanelCaLam,
                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                                                .addGroup(PanelTongLayout
        ...
        public void insert() {
                ...
                String inError = LichLam_CaLam.check_time_CaLam(in);
                if (!inError.equals("")) {
                        JOptionPane.showMessageDialog(null, inError, "Sai định dạng (hh:mm)",
                ...
                if (!LichLam_CaLam.check_time_CaLam(out).equals("")) {
                        JOptionPane.showMessageDialog(null, LichLam_CaLam.check_time_CaLam(out),
                                        "Sai định dạng (hh:mm)",
                                        JOptionPane.WARNING_MESSAGE);
                        return;
                }

                if (toMinutes(out) <= toMinutes(in)) {
                        TextThoiGianRa.requestFocus();
                        JOptionPane.showMessageDialog(null, "Giờ ra phải lớn hơn giờ vào");
                        return;
                }
        ...
        public void update() {
                ...
                if (ma.equals(CaLamBUS.getInstance().MaTuDong())) {
                        JOptionPane.showMessageDialog(null, "Vui lòng chọn 1 ca làm trong danh sách để sửa!",
                                        "Thông báo",
                        ...
                        if (!LichLam_CaLam.check_time_CaLam(in).equals("")) {
                                JOptionPane.showMessageDialog(null, LichLam_CaLam.check_time_CaLam(in),
                                                "Sai định dạng (hh:mm)",
                                                JOptionPane.WARNING_MESSAGE);
                                TextThoiGianVaoCa.requestFocus();
                                return;
        ...
        public void delete() {
                ...
                if (ma.equals(CaLamBUS.getInstance().MaTuDong())) {
                        JOptionPane.showMessageDialog(null, "Vui lòng chọn 1 ca làm trong danh sách để xóa!",
                                        "Thông báo",
                                        JOptionPane.INFORMATION_MESSAGE);
                } else {
                        if (ma.equals("")) {
        ...
        public void nhomNutChucNang() {
                ...
                Table.addMouseListener(new java.awt.event.MouseAdapter() {
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                                ...
                                TextThoiGianVaoCa.setText(Util.LichLam_CaLam
                                                .time_sql_sang_hhmm(model.getValueAt(count, 3).toString()));
                                TextThoiGianRa.setText(Util.LichLam_CaLam
                                                .time_sql_sang_hhmm(model.getValueAt(count, 4).toString()));
                        }
                });
        }
