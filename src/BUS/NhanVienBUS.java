...
public class NhanVienBUS {
    ...
    public boolean themNhanVien(String ten, String gioitinh, String dienThoai, Date ngaysinh, String chucvu,
            String diachi, int luong, int trangThai) {
        ten = ten.trim();
    ...
    public boolean updateNhanVien(String ma, String ten, String gioitinh, String dienThoai, Date ngaysinh,
            String chucvu, String diachi, int luong, int trangThai) {
        ten = ten.trim();
        dienThoai = dienThoai.trim();
        if (ten.equals("")) {
    ...
    // Hàm nhập excel
    public boolean nhapExcel(String ma, String ten, String gioitinh, String dienThoai, Date NgaySinh, String chucvu,
            String diachi, int luong, int trangThai) {
        NhanVienDTO nv = new NhanVienDTO();
        nv.setMaNhanVien(ma);
        nv.setTenNhanVien(ten);
