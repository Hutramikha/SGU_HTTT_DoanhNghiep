...
public class n5_NguyenLieuGUI extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                comboboxTrangThai
                                .setModel(new javax.swing.DefaultComboBoxModel<>(
                                                new String[] { "Mã Nguyên Liệu", "Tên Nguyên Liệu" }));
                        ...
                        public void valueChanged(ListSelectionEvent event) {
                                ...
                                if (!event.getValueIsAdjusting()) {
                                        ...
                                        if (selectedRow != -1) {
                                                ...
                                                String khoiLuong = String
                                                                .valueOf(tb_DanhSachNL.getValueAt(selectedRow, 2));
                                                String donGia = String
                                                                .valueOf(tb_DanhSachNL.getValueAt(selectedRow, 3));
                                                tf_MaNL.setText(ma);
        ...
        public void btn_SuaAction() {
                int selectedRow = tb_DanhSachNL.getSelectedRow();
                if (selectedRow != -1) {
                        int confirm = JOptionPane.showConfirmDialog(null, "Bạn có muốn sửa nguyên liệu này?",
                                        "Xác nhận",
                        ...
                        if (confirm == JOptionPane.YES_OPTION) {
                                ...
                                if (ten.length() > 50) {
                                        JOptionPane.showMessageDialog(null,
                                                        "Tên nguyên liệu không được vượt quá 50 ký tự !", "Thông báo",
                                                        JOptionPane.ERROR_MESSAGE);
                                        return;
                                }
                                if (ten.matches(regex)) {
                                        JOptionPane.showMessageDialog(null,
                                                        "Tên nguyên liệu không được chứa ký tự đặc biệt !", "Thông báo",
                                                        JOptionPane.ERROR_MESSAGE);
                                        return;
                                }
        ...
        public void btn_ThemAction() {
                if (!tf_MaNL.getText().equals("")) {
                        JOptionPane.showMessageDialog(null, "Nguyên liệu đã tồn tại !", "Thông báo",
                                        JOptionPane.ERROR_MESSAGE);
                        return;
                }
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                        ...
                        if (ten.length() > 50) {
                                JOptionPane.showMessageDialog(null, "Tên nguyên liệu không được vượt quá 50 ký tự !",
                                                "Thông báo",
                                                JOptionPane.ERROR_MESSAGE);
                                return;
                        }
        ...
        public void btn_XoaAction() {
                int selectedRow = tb_DanhSachNL.getSelectedRow();
                if (selectedRow != -1) {
                        if (nguyenLieuBUS.getNguyenLieuById(String.valueOf(tf_MaNL.getText()))
                                        .getKhoiLuongNguyenLieu() != 0) {
                                JOptionPane.showMessageDialog(null, "Vui lòng sử dụng hết nguyên liệu trước khi xóa !",
                                                "Thông báo",
                                                JOptionPane.ERROR_MESSAGE);
                                return;
                        }
                        int confirm = JOptionPane.showConfirmDialog(null, "Bạn có muốn xóa nguyên liệu này?",
                                        "Xác nhận",
                                        JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                        if (confirm == JOptionPane.YES_OPTION) {
                                String ma = String.valueOf(tf_MaNL.getText());
